            ...
            <div className="w-11/12 container py-8 mx-auto">
                ...
                <div className="flex flex-col items-center sm:flex-row sm:justify-between gap-4">
                    ...
                    <div className="flex -mx-2">
                        <a href="https://facebook.com/maksud51" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-sage-green-500 dark:hover:text-sage-green-400" aria-label="Facebook">
                        ...
                        <a href="https://github.com/AbdullahAlMaksud" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-sage-green-500 dark:hover:text-sage-green-400" aria-label="Github">
                            <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
