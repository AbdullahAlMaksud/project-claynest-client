    ...
    return (
        <div className='w-11/12 container mx-auto mb-10'>
            <section className="bg-white/20 rounded-xl dark:bg-gray-900">
                ...
                <p className='text-center md:col-span-2 lg:col-span-3  lg:pl-96 lg:text-right text-gray-600 dark:text-gray-300'>Discover artisanal pottery in various styles, from traditional clay-made pieces to contemporary home decor pottery. Explore our curated collection for timeless designs that add character to any space.</p>
