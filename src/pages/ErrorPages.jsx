            ...
            <section className="bg-sage-green-100 dark:bg-gray-900">
                <div className="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
                    <div className="w-full lg:w-1/2">
                        <p className="text-xl text-center lg:text-left font-medium text-blue-500 dark:text-blue-400">404 error</p>
                        <h1 className="mt-3 text-center lg:text-left text-4xl font-semibold text-gray-800 dark:text-white md:text-6xl">Page not found</h1>
                        <p className="mt-4 text-gray-500 dark:text-gray-400 text-center lg:text-left">Sorry, the page you are looking for does not exist. Here are some helpful links:</p>

                        <div className="flex items-center mt-6 gap-x-3 justify-center lg:justify-start">
